...
OptionHandler::ArgumentVector::addArg(
    ...
    const std::string & help)
{
    return add(name, required_argument, shortVersion, cb, argText, help);
}
 ...
 */
OptionHandler::ArgPointer
OptionHandler::ArgumentVector::addNoArg( const char *name, char shortVersion, CallbackFunction cb, const std::string & help) {
    return add(name, no_argument, shortVersion, cb, "", help);
}
