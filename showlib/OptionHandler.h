...
public:
    ...
    class Argument {
    public:
        typedef std::shared_ptr<Argument> Pointer;
    ...
    public:
        ...
        ArgPointer addArg  (const char *_name, char shortVersion, CallbackFunction cb, const std::string & argText = "", const std::string & help = "");
